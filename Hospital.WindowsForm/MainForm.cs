...
namespace Hospital.WindowsForm
{
    public partial class MainForm : Form
    {
        ...
        private void showMarkStripMenuItem_Click(object sender, EventArgs e)
        {
            string res = ConfigurationManager.OpenExeConfiguration(ConfigurationUserLevel.None)
                .AppSettings.Settings["mark"].Value;
            MessageBox.Show(res, "Ваш результат:");
        }
    }
}
